(function($) {
    ...
    var switcherHtml = `<div class="style-switcher-box"> <div class="switcher-inner"><h5>Style Switcher</h5> <div class="main-list"> <div class="col-md-12 padding0">
    <form class="contact-form form contact-validation-active row" id="contact-form-s2">
        ...
        <div class="col col-sm-12 submit-btn margin-top-10">
...
</div></div> <button class="toggle-btn"><i class="fa fa-cog"></i></button> </div>`;
